...
códigos \LaTeX, ao compilar o documento a formatação não sai como você previa.
...
Desse modo, se for digitado {\tt tvim} sem qualquer argumento, é exibida a mensagem de erro, do contrário,
