...
Talvez você pode ter notado alguns arquivos com o mesmo nome dos arquivos que você editou e um
til (\textasciitilde) no final. Esses arquivos são backups que o Vim gera antes de sobreescrever o arquivo.
Se você deseja que esse backup seja feito enquanto o arquivo esteja sendo escrito, porém não 
quer manter o arquivo após terminar, utilize no seu \verb|.vimrc|:
