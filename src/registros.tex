...
Este registro na verdade é usado em algumas funções avançadas. Veja 
um vídeo demonstrando sua utilização aqui: \url{http://vimeo.com/2967392}.


Para entender melhor como funciona o registro de expressões
tomemos um exemplo. Digamos que queremos fazer uma sequência
como abaixo:
...
Acompanhe os passos para a criação de uma macro que lhe permitira fazer uma
sequência de quantas linhas quiser com o incremento proposto acima.
...
\begin{enumerate}
 ...
 \item  Mapeamento para o modo de inserção ``{\tt imap}'' digite ,d
 \item  Mapeamento para o modo normal ``{\tt nmap}'' digite ,d
\end{enumerate}
