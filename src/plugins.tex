...
para criar uma entrada (acesso ao plugin) no meno do Gvim colocamos
...
Ao recarregar o Vim pode-se abrir o {\em Plugin} ``{\em :Projetc}'' e 
pressionar o atalho {\tt \\r} para que o mesmo gere um índice dos arquivos
