...
conhecem o poder do comando {\em Grep}, usando este comando procuramos palavras dentro 
de arquivos, este plugin simplifica a tarefa de usar o grep, além de permitir a utilização
da versão do Grep nativa do Vim {\em vimgrep}, assim usuários do Windows também podem usar 
o grep. Um comando grep funciona mais ou menos assim:
