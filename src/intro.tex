...
%
A tecla ``\verb|<Ctrl>|''\index{tecla!\texttt{<ctrl>}} é representada na
maioria dos manuais e na ajuda pelo caractere ``\verb|^|'' circunflexo, ou
seja, o atalho \verb|Ctrl-L| aparecerá assim: `\verb+^L+'.  No arquivo de
configuração do Vim, um ``\verb|<Enter>|'' pode aparecer como  `\verb+<cr>+'.
