...
Pode-se guardar trechos distintos de texto copiado ou apagado para
registros distintos (área de trasnferência múltipla). Para isso usamos 
``registros''.  Os registros são indicados por aspas seguido por uma letra.
