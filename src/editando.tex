...
\section{Comparando arquivos com o {\em vimdiff}}
\label{sec:Comparando arquivos com o {\em vimdiff}}

O vim possui um modo para checagem de diferenças entre arquivos, é bastante
útil especialmente para programadores, se por acaso você tem dúvida sobre quais
são as diferenças entre dois arquivos basta fazer:
