...
%Uma ferramenta bastante útil é a de poder compilar seus programa de dentro do Vim
%e ainda verificar os erros e warnings. O :make executará o comando que está
%definido na variável makeprg, que normalmente é o comando make mesmo:
...
de quickfix:
%Se durante a sua compilação você obteve algum erro ou warning, você poderá abrir
%uma janela chamada de quickfix:
...
a eles.
%Use cwindow e a janela de quickfix para exibir os resultados e poder ir diretamente a eles.
