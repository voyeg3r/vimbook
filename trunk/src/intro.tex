...
O ``Vim''\index{vim} é um editor de texto extremamente configurável, criado para
...
{\em{Expressões
Regulares}}\index{Expressões Regulares}\footnote{http://guia-er.sourceforge.net/guia-er.html}, entre
...
ter vários significados, exemplificando: Em modo normal pressionar `{\tt dd}'
