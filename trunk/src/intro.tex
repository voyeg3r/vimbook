...
Vim pressione \key{Esc} e em seguida:
...
\end{verbatim}
%
ou simplesmente \key{F1}

Siga os links usando o atalho \key{ctrl}+\key{]}, em modo gráfico o clique com o
mouse também funciona, e para voltar use \key{ctrl}+\key{o} ou
\key{ctrl}+\key{t} Para as situações de desespero pode-se digitar:
...
\key{Esc} e em seguida usando o comando `\texttt{:e}'.
