...
\href{http://www.vim.org/scripts/script.php?script\_id=2208&rating=helpful#1.3}{link para baixar}
...
``\href{http://ctags.sourceforge.net/}{link}''. O plugin de {\em Ctags} para o Vim está no 
``\href{http://vim.sourceforge.net/scripts/script.php?script\_id=12}{endereço}'', 
e para instalá-lo basta copiá-lo para a pasta apropriada:
