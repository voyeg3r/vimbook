...
\subsection{sub:Mapeamento para Calcular Expressões}
...
Para efetuar calculos com maior precisão e também resolver problemas como
potências raizes, logaritmos pode-se mapear comandos externos, como a
