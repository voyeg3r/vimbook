...
\label{Mapeamento para Calcular expressões}

Os mapeamentos abaixo exibem o resultado das quatro operações básicas da
matemática. O primeiro para o modo normal (posiciona-se o cursor no primeiro
caractere da expressão tipo {\tt 5*9} e em seguida pressiona-se {\tt Shift-F1},
o segundo {\em em modo insert}, após digitada a expressão pressiona-se o mesmo
atalho, no caso {\tt Shift-F1}.
