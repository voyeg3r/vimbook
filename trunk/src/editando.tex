...
de arquivo.  Se você estiver editando um arquivo e desejar abandoná-lo, o Vim
...
Isto fará o Vim dar um salto até a marca `A' mesmo que esteja em outro arquivo,
...
Apesar de usar a extensão `{\tt sh}' o Vim reconhecerá este arquivo como `txt', e
