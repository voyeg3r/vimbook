...
utilização \href{http://vimeo.com/2967392}{neste link}.
...
claro o uso do registro de buscas ``/''. {\Large {\ding{45}}} Pode-se colocar
...
{\Large {\ding{45}}} Há situações em que se tem caracteres não `{\tt ascii}' que
